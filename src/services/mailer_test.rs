...
pub static K_ACCOUNT_EMAIL: &str = "yuantingwei@arcsparrow.com";
pub static K_ACCOUNT_NICKNAME: &str = "yuantingwei";
pub static K_ACCOUNT_PASSWORD: &str = "yuantingwei";
...
async fn account_init() -> (String, String) {
    ...
    let mut response = srv
        ...
        .send_json(&AccountAuthRequest {
            ...
            provider: AuthProvider::RssmailerAuth as u32,
        })
        .await
        .unwrap();
    assert!(response.status().is_success());
