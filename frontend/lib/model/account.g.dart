...
AccountVerifyEmailRequest _$AccountVerifyEmailRequestFromJson(
        Map<String, dynamic> json) =>
    AccountVerifyEmailRequest(
      email: json['email'] as String,
    );

Map<String, dynamic> _$AccountVerifyEmailRequestToJson(
        AccountVerifyEmailRequest instance) =>
    <String, dynamic>{
      'email': instance.email,
    };

AccountVerifyEmailResponse _$AccountVerifyEmailResponseFromJson(
        Map<String, dynamic> json) =>
    AccountVerifyEmailResponse(
      status: json['status'] as int,
    );

Map<String, dynamic> _$AccountVerifyEmailResponseToJson(
        AccountVerifyEmailResponse instance) =>
    <String, dynamic>{
      'status': instance.status,
    };
